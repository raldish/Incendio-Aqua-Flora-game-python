...
class RpsGame():
    def __init__(self):
        ...
        pygame.display.set_caption("Fire Water Plant Game")

        self.bg = pygame.image.load("img/background1.jpg")
        self.r_btn = pygame.image.load("img/f_fire.png").convert_alpha()
        self.p_btn = pygame.image.load("img/w_water.png").convert_alpha()
        self.s_btn = pygame.image.load("img/p_plant.png").convert_alpha()

        self.choose_rock = pygame.image.load("img/fire.png").convert_alpha()
        self.choose_paper = pygame.image.load("img/water.png").convert_alpha()
        self.choose_scissors = pygame.image.load("img/plant.png").convert_alpha()
    ...
    def computer(self):
        ...
        option = ["fire", "water", "plant"]
        pc_choice = random.choice(list(option))
        if pc_choice == "fire":
            self.pc_random_choice = "fire"
            pc_choice = self.choose_rock
        elif pc_choice == "water":
            self.pc_random_choice = "water"
            pc_choice = self.choose_paper
        else:
            self.pc_random_choice = "plant"
    ...
    def pl_score_cache(self):
        ...
        if pl == "fire" and pc == "water" or pl == "water" and pc == "plant" or pl == "plant" and pc == "fire":
            self.pc_score += 1
        elif pl == pc:
            pass
        else:
